...
import { viewConvertor } from "../../utils/utilsFunc.js";
import { setSelectedVideo } from "../../store/youtubeVideo/youtubeSlice.js";
...
const Index = memo((props) => {
  ...
  const categoryId = useSelector((state)=>state.youtube.categoryId)
  ...
  const fetchVideos = async (pageToken = null) => {
    ...
    try {
      ...
      if([0, 2, 10, 17, 18, 20, 23, 24, 25, 28, 30, 42, 44].includes(categoryId)){
        params={
          ...params,
  ...
  /*const handleScroll = () => {
    if (
      ...
      document.documentElement.offsetHeight - 50 // Near bottom of the page
    ) {
      if (!loading && nextPageToken) {
        // fetchVideos(nextPageToken); // Fetch next page of videos
      }
    }
  };*/
  ...
  const TimeAgo = (dateString) => {
    const formattedTime = moment(dateString).fromNow();
                  ...
                  <div className="card-body">
                    <div className="progress-widget">
                      ...
                      <div className="progress-detail">
                        ...
                        <h4 className="counter">
                          <CountUp start={2} end={11.2} duration={3} decimals={1} />M
                        </h4>
                      </div>
                    </div>
                  </div>
