...
import { setCategoryId } from '../../../../store/youtubeVideo/youtubeSlice';
...
const MenuItem = ({ pathname, name, menuTitle, icon }) => {
    ...
    return (
      <li className={`${location.pathname === pathname ? 'active' : ''} nav-item`}>
        <Link
          className={`${location.pathname === pathname ? 'active' : ''} nav-link`}
          aria-current="page"
          to={pathname}
          onClick={() => dispatch(setCategoryId(0))}
        >
          <i className="icon">{icon}</i>
          <span className="item-name">{menuTitle}</span>
        </Link>
      </li>
    );
};
...
const VerticalNavMenuItem = () => {
    let location = useLocation();
    const dispatch=useDispatch();
    const {categoryId} = useSelector(state => state.youtube);
    const menuItems=[
        {
            pathname : '/',
            name : 'Home',
        ...
        },
        {
            ...
            name : 'Comedy',
            categoryId: 23,
            iconSvg : <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" data-testid="MoodIcon"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8m3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5m-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11m3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5"></path></svg>
        },
        {
            pathname : '/',
            name : 'Entertainment',
            categoryId: 24,
            iconSvg : <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="TheaterComedyIcon"><path d="M2 16.5C2 19.54 4.46 22 7.5 22s5.5-2.46 5.5-5.5V10H2zm5.5 2C6.12 18.5 5 17.83 5 17h5c0 .83-1.12 1.5-2.5 1.5M10 13c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1m-5 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1"></path><path d="M11 3v6h3v2.5c0-.83 1.12-1.5 2.5-1.5s2.5.67 2.5 1.5h-5v2.89c.75.38 1.6.61 2.5.61 3.04 0 5.5-2.46 5.5-5.5V3zm3 5.08c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1c0 .56-.45 1-1 1m5 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1c0 .56-.45 1-1 1"></path></svg>
        },
        {
            pathname : '/',
            name : 'Music',
        ...
        /*{
            ...
            name : 'Short Movies',
            categoryId: 18,
            iconSvg : <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                        <path fillRule="evenodd" clipRule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                    </svg>
        },
        ...
        },
        {
            ...
            categoryId: 28,
            iconSvg : <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ScienceIcon"><path d="M19.8 18.4 14 10.67V6.5l1.35-1.69c.26-.33.03-.81-.39-.81H9.04c-.42 0-.65.48-.39.81L10 6.5v4.17L4.2 18.4c-.49.66-.02 1.6.8 1.6h14c.82 0 1.29-.94.8-1.6"></path></svg>
        },
    ]
  return (
    <>
    {menuItems.length > 0 && menuItems.map((menuItem, i) => (
        // <li className={`${location.pathname === '/' ? 'active' : ''} nav-item `} key={i}>
        <li className={`${categoryId === menuItem?.categoryId ? 'active' : ''} nav-item `} key={i}>
            {/* <Link className={`${location.pathname === '/dashboard' ? 'active' : ''} nav-link `} aria-current="page" to="/" onClick={() => dispatch(setCategoryId(menuItem?.categoryId))}> */}
            <Link className={`${categoryId === menuItem?.categoryId ? 'active' : ''} nav-link `} aria-current="page" to="/YouTube" onClick={() => dispatch(setCategoryId(menuItem?.categoryId))}>
                <i className="icon">
                    {menuItem?.iconSvg}
                </i>
